...
import { addListenerMulti } from './utils';
global.THREE = THREE;
...
(function(global, factory) {
    ...
    function Infospot(scale = 300, imageSrc, animated) {
        ...
        this.showAnimation._reversed = true;
        this.showAnimation._yoyo = true;
        this.showAnimation._repeat = Infinity;
        this.showAnimation._repeatDelayTime = 500;

        this.showAnimationStop = new Tween.Tween(this.material)
            .to({ opacity: 1 }, duration)
            .onStart(this.enableRaycast.bind(this, true))
            .easing(Tween.Easing.Quartic.Out);
    ...
    Infospot.prototype = Object.assign(Object.create(THREE.Sprite.prototype), {
        ...
        translateElement: function(x, y) {
            ...
            let left, top, element, width, height, delta, theta, container;
            ...
            theta = element.horizontalDelta !== undefined ? element.horizontalDelta : 40;
         ...
         * @instance
         */
        addHoverElement: function(el, delta = 40, theta = 40) {
            ...
            if (!this.element) {
                ...
                this.element.classList.add('panolens-infospot');
                this.element.verticalDelta = delta;
                this.element.horizontalDelta = theta;
    ...
    Widget.prototype = Object.assign(Object.create(THREE.EventDispatcher.prototype), {
        ...
        createVideoControlSeekbar: function() {
            ...
            let scope = this,
                item, progressElement, progressElementControl,
                isDragging = false,
                mouseX, percentageNow, percentageNext;
    ...
    function OrbitControls(object, domElement) {
        ...
        function onKeyDown(event) {
            ...
            if (!event) {
                keyUp = false, keyBottom = false, keyLeft = false, keyRight = false;
                switch (eventType) {
                    case 'up':
                        keyUp = true;
                        break;
        ...
        const ctrs = document.querySelectorAll('.ctrl-direction');

        ctrs.forEach((ctr) => {
            addListenerMulti(ctr, 'mousedown touchstart', (e) => {
                e.preventDefault();
                eventType = e.currentTarget.getAttribute('data-ctrl');
                startAnimate();
            });
            addListenerMulti(ctr, 'mouseup touchend', (e) => {
                e.preventDefault();
                stopAnimate();
            });
        });
    ...
    Viewer.prototype = Object.assign(Object.create(THREE.EventDispatcher.prototype), {
        ...
        enableEffect: function(mode) {
            ...
            if (mode === MODES.NORMAL) { this.disableEffect(); return; } else { this.mode = mode; }
